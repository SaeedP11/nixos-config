...
#
# Taken one attribute at a time, the same way vicinae is. It adds nothing
# to flake.lock, which already carries nixpkgs-unstable, but like vicinae it
# is a Qt/QML application and so brings unstable's Qt rather than sharing
# 25.05's.
#
