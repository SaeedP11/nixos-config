...
Singleton {
    ...
    readonly property string stop: g(0xF04DB)
    ...
    readonly property string emoji: g(0xF01F5)
    readonly property string keyboard: g(0xF030C)
    readonly property string grid: g(0xF0570)
    readonly property string vpn: g(0xF0582)
    readonly property string shieldLock: g(0xF099D)
    readonly property string lockOpen: g(0xF033F)
    readonly property string arrowRight: g(0xF0054)
    ...
    readonly property string plus: g(0xF0415)
    readonly property string link: g(0xF0337)
    readonly property var wifiStrength: [g(0xF092F), g(0xF091F), g(0xF0922), g(0xF0925), g(0xF0928)]
